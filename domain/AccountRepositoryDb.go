...
func(d AccountRepositoryDb) SaveTransaction(t Transaction)(*Transaction, *errs.AppError){
	...
	result, _ := tx.Exec(`insert into transactions(account_id, amount, transaction_type, transaction_date) values (?,?,?,?)`,t.AccountId, t.Amount, t.TransType, t.TransDate)

	if t.TransType == "withdrawal" {
	...
	t.TransId = strconv.FormatInt(transactionId, 10)
